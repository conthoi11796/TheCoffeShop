...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
      ...
      <div class="form-group">
          <input id="name" type="text" value= '<c:out value="${product.getName()}" />' class="form-control" placeholder="Tên sản phẩm"/>
      </div>
      <div class="form-group">
          <textarea id="description" class="form-control" rows="2" placeholder="Mô tả sản phẩm" >
...
<script src="../resouces/ajax-jquery/product-edit.js"></script>