...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <div class="form-group">
        <input id="tablestatusid" type="hidden" value= '<c:out value="${tablestatus.getTablestatusid()}" />' />
        <input id="name" type="text" value= '<c:out value="${tablestatus.getName()}" />' class="form-control" placeholder="Tên trạng thái"/>
      </div>
