								...
								<select class="form-control form-control-sm nav-search"
									...
									<c:forEach items="${categoryProducts}" var="categoryProduct">
										<option
											...
											<c:out value="${categoryProduct.getCgPrdName() }"></c:out>
										</option>
									</c:forEach>
								</select>
							</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu cart-dropdown your-card"
										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img
														src="../resouces/images/my-images/25881311567_bc11131457.jpg"
														alt="">
												</div>
												<div class="product-body">
													...
													<h4 class="product-price">
														<span class="qty">1x</span>980.000đ
													</h4>
												</div>
												<button class="delete">
											...
											<div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price">
														<span class="qty">3x</span>980.000đ
													</h4>
												</div>
												<button class="delete">
													<i class="fa fa-close"></i>
										...
										<div class="cart-btns row">
											<a href="#">Làm mới</a> <a href="#">Thanh toán <i
			...
			<div class="">
				<div class="content-wrapper dislpay-product"
					...
					<div class="row section social-section">
						<div class="row">
											...
											<div class="product-label">
												<c:if test="${priceProducts[i][2]!=null}">
													<span class="sale"> <c:out
															value="-${priceProducts[i][4]}%" /> <c:out
															value="Từ ${priceProducts[i][3]}" />
													</span>
												</c:if>
										...
										<div class="product-body">
											...
											<h4 class="product-price">
												<c:if test="${priceProducts[i][0] == product.getPId()}">
													<c:if test="${priceProducts[i][2]!=null}">
														<c:out value="${priceProducts[i][2]}" />đ 
							<del class="product-old-price">
													...
													<c:if test="${priceProducts[i][2]==null}">
														<c:out value="${priceProducts[i][1]}" />đ 
						</c:if>
												</c:if>
											</h4>
											...
											<div class="product-btns">
												...
												<button title="Xem nhanh" class="quick-view" tabindex="-1"
													data-toggle="modal" data-target="#exampleModal">
													<i class="fa fa-eye"></i>
												</button>
												<button title="Thêm vào giỏ" class="quick-view"
													tabindex="-1">
									...
									<div class="modal-content">
										<div class="modal-body">
											...
											<div class="container row">
												<div class="col-lg-8">
													<div id="product_details" class="carousel slide"
														data-ride="carousel">
														<ol class="carousel-indicators">
															<i class="fa fa-caret-left active"
																data-target="#product_details" data-slide-to="0"></i>
															<i class="fa fa-square " data-target="#product_details"
																data-slide-to="1"></i>
															<i class="fa fa-caret-right"
																data-target="#product_details" data-slide-to="2"></i>
														</ol>
														<div class="carousel-inner">
															<div class="carousel-item active">
																<img class="d-block w-100 col-lg-12"
																	src="../../images/my-images/15015802962_d494f36194.jpg"
																	alt="First slide">
															</div>
															<div class="carousel-item ">
																<img class="d-block w-100 col-lg-12"
																	src="../../images/my-images/35487991553_3fc6715447.jpg"
																	alt="Second slide">
															</div>
															<div class="carousel-item">
																<img class="d-block w-100 col-lg-12"
														...
														<a class="carousel-control-prev" href="#product_details"
															...
															<div class="card-body p-3">
																<div class="media">
																	...
																	<div class="media-body">
																		<h6 class="mb-1">
																			<i
																				class="mdi mdi-check-all icon-sm text-success align-self-center mr-3"></i>
																			Tên sản hẩm
																		</h6>
															...
															<div class="card-body p-3">
																<div class="media">
																	...
																	<div class="media-body">
																		<h6 class="mb-1">
																			<i
																				class="mdi mdi-check-all icon-sm text-success align-self-center mr-3"></i>Giá
																		</h6>
															...
															<div class="card-body p-3">
																<div class="media">
																	<div class="media-body">
																		<h6 class="mb-1">
																			<i
																				class="mdi mdi-check-all icon-sm text-success align-self-center mr-3"></i>Mô
																			tả
																		</h6>
																		<p class="mb-0 text-muted">Trà sữa trân châu chỉ
																			bao gồm trà sữa và trân châu đen, dành riêng cho tín
																			đồ thích trà sữa trân châu truyền thống.</p>
																	</div>
																</div>
															</div>
														</div>
					...
					<div
						...
						<a href="index?page=2&cgPrdId=null&strSearch=null"
