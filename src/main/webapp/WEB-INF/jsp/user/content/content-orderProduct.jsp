                                            ...
                                            <c:forEach items="${productDTOs}" var="productDTO">
                                                <tr>
                                                    <td class="py-1"><img
                                                        ...
                                                        alt="image"> <c:out
                                                            value="${productDTO.getProduct().getName() }"></c:out>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="/pay-cart" class="forms-sample">
                                    <input id="listCart" name="listCart" type="hidden" value="<c:out value='${listCart }'></c:out>" class="form-control form-control-sm">
                                    <input id="listNumberProduct2" name="listNumberProduct2" type="hidden" value="<c:out value='${listNumberProduct }'></c:out>" class="form-control form-control-sm">
                                    ...
                                    <div class="form-group">
                                        <textarea id="notice" name="notice" class="form-control" placeholder="Ghi chú:" rows="3"></textarea>
                                    </div>
                                    <div class="form-group">
