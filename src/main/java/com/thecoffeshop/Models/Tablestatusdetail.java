...
public class Tablestatusdetail implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "dnId", column = @Column(name = "DN_ID", nullable = false)),
			@AttributeOverride(name = "tsId", column = @Column(name = "TS_ID", nullable = false)) })
